...
export default function ShowDetails(){
    ...
    const url = `https://api.themoviedb.org/3/tv/${params.showID}?api_key=${API_KEY}`;
    ...
    return (
        <div>
            ...
            <div className="custom-container">
                <img src={`https://image.tmdb.org/t/p/w500/${show.poster_path}`} alt={show.original_title} className="title-img" />
                ...
                <div className="details">
                    ...
                    <div><ul>{show.spoken_languages?.map(spoken_languages => 
